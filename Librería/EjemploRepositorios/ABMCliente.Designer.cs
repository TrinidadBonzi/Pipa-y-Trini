namespace CPresentacion
{
    partial class ABMCliente
    {
        ...
        private void InitializeComponent()
        {
            ...
            lbApellidoCliente = new Label();
            tbDocumentoCliente = new TextBox();
            lbDocumentoCliente = new Label();
            tbNacionalidadCliente = new TextBox();
            lbNacionalidadCliente = new Label();
            tbEmailCliente = new TextBox();
            lbEmailCliente = new Label();
            tbTelefonoCliente = new TextBox();
            lbTelefonoCliente = new Label();
            lbSocioCliente = new Label();
            cbSocioCliente = new ComboBox();
            dgvListadoClientes = new DataGridView();
            btGuardarCliente = new Boton();
            btActualizar = new Boton();
            btEliminarCliente = new Boton();
            ...
            // btGuardarCliente
            // 
            btGuardarCliente.BackColor = Color.Black;
            btGuardarCliente.BackgroundColor = Color.Black;
            btGuardarCliente.BorderColor = Color.DeepPink;
            btGuardarCliente.BorderRadius = 40;
            btGuardarCliente.BorderSize = 3;
            btGuardarCliente.FlatAppearance.BorderSize = 0;
            ...
            btGuardarCliente.UseVisualStyleBackColor = false;
            btGuardarCliente.Click += btGuardarCliente_Click;
            // 
            // btActualizar
            // 
            btActualizar.BackColor = Color.Black;
            btActualizar.BackgroundColor = Color.Black;
            btActualizar.BorderColor = Color.DeepPink;
            btActualizar.BorderRadius = 40;
            btActualizar.BorderSize = 3;
            ...
            btEliminarCliente.BackgroundColor = Color.Black;
            btEliminarCliente.BorderColor = Color.DeepPink;
            btEliminarCliente.BorderRadius = 40;
            btEliminarCliente.BorderSize = 3;
            ...
            Controls.Add(cbSocioCliente);
            Controls.Add(lbSocioCliente);
            Controls.Add(tbTelefonoCliente);
            Controls.Add(lbTelefonoCliente);
            Controls.Add(tbEmailCliente);
            Controls.Add(lbEmailCliente);
            Controls.Add(tbNacionalidadCliente);
            Controls.Add(lbNacionalidadCliente);
            Controls.Add(tbDocumentoCliente);
            Controls.Add(lbDocumentoCliente);
        ...
        private Label lbDocumentoCliente;
        private TextBox tbNacionalidadCliente;
        private Label lbNacionalidadCliente;
        ...
        private Label lbSocioCliente;
        private ComboBox cbSocioCliente;
        private DataGridView dgvListadoClientes;
        private Boton btGuardarCliente;
        private Boton btActualizar;
        private Boton btEliminarCliente;
